...
public class PlayerResponse2 : MonoBehaviour
{
    ...
    public NPCResponse3 NPCResponse3;
    private void Start()
    {
    ...
    private void NextLine()
    {
        ...
        {
            ZeroText();
            if (NPCResponse3 != null && NPCResponse3.gameObject.activeInHierarchy && NPCResponse3.enabled)
            {
                NPCResponse3.StartResponse();
            }
        }
    }
